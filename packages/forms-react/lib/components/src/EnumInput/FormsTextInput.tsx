...
const FormsTextInput: React.FC<FormsTextInputInteface> = ({
  ...
  return (
    ...
    //         type="text"
    //         className={cn(
    //           "relative flex items-center justify-start px-2 w-full gap-2 whitespace-nowrap text-[10px] font-normal text-[#666666] transition-colors focus:border-orange-200 focus:ring-0 focus:outline-none disabled:pointer-events-none disabled:opacity-50",
    //           "[&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 bg-[#EEEEEE]",
    //           "h-14 px-4 py-2 border hover:bg-accent",
    //           errors
    //             ? "border-red-500 text-[#d32f2f] focus:border-none"
    //             : "border-border bg-background shadow-sm hover:text-accent-foreground"
    //         )}
    //         aria-expanded={open}
    //         value={values}
